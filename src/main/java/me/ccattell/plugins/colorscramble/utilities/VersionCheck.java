package me.ccattell.plugins.colorscramble.utilities;
...
public class VersionCheck {
    ...
    public VersionCheck(ColorScramble plugin, String url){
        try {
    ...
    public boolean updateNeeded() {
        try {
            ...
            while (test == false && i < num_files) {
                ...
                version = children.item(1).getTextContent().toLowerCase().replace("colorscramble ", "");
